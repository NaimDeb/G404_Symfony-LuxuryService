 ...
 */
final class Version20250207140834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate ADD gender_id INT DEFAULT NULL, ADD job_category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate DROP gender_id, DROP job_category_id');
    }
}
